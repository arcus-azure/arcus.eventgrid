...
using Arcus.EventGrid.Core.Publishing;
...
{
    public abstract class EventGridPublisherWithTrackingClientTests
    {
        protected readonly string _transactionId = $"transaction-{Guid.NewGuid()}";
        protected readonly TestConfig _config = TestConfig.Create();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventGridPublisherWithTrackingClientTests"/> class.
        /// </summary>
        protected EventGridPublisherWithTrackingClientTests(
        ...
        {
            IServiceProvider provider = RegisterEventGridPublisherClient(configureOptions);
        ...
        private IServiceProvider RegisterEventGridPublisherClient(
            Action<EventGridPublisherClientWithTrackingOptions> configureOptions = null)
        {
            ...
            var builtInDefaultAzureClientName = "Default";
            services.AddAzureClients(builder =>
            {
                builder.AddEventGridPublisherClient(topicEndpoint, authenticationKeySecretName, configureOptions);
            });
        ...
        protected string AssertDependencyTracking(string dependencyId = null)
        {
            ...
            Assert.Contains(_eventSchema.ToString(), logMessage);
